  ...
  <div class="login-page min-h-screen flex items-center justify-center relative overflow-hidden bg-background text-foreground">
    <Button
      ...
      :class="isDark
        ...
        : 'border-slate-400/60 bg-slate-200/80 hover:bg-slate-200 shadow-sm'"
...
<div class="absolute w-20 h-20 rounded-full border" :class="isDark ? 'border-primary/10' : 'border-primary/20'"></div>
      ...
      >
        ...
        <div
          ...
          :class="isDark
            ...
            : 'bg-slate-200/88 border-border/80 shadow-[0_10px_28px_rgba(60,76,99,0.14)]'"
        >
          <!-- Top accent line -->
      ...
      <div 
        ...
        :class="mounted ? 'opacity-100' : 'opacity-0'"
      >
        <p class="text-slate-600/80 text-[10px] tracking-wider font-mono">&copy; 2026 智能安全实验室</p>
      </div>
    </div>
  </div>
</template>
