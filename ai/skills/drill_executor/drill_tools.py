...
def get_drill_tool_definitions() -> list[dict]:
    ...
    if _TOOL_DEFS_CACHE is None:
        ...
        # ── 文档分析 ─────────────────────────────────────────────────────────
        {
            'type': 'function',
            'function': {
                'name': 'drill_analyze_and_plan',
                'description': '解析文档，提取目标网络和服务类型',
                'parameters': {
                    'type': 'object',
                    'properties': {
                        'document_content': {
                            'type': 'string',
                            'description': '安全演练文档内容',
                        },
                    },
        ...
        # ── RDP弱口令 ───────────────────────────────────────────────────────
        {
            ...
            'function': {
                ...
                'parameters': {
                    ...
                    'properties': {
                        'target_ip': {'type': 'string', 'description': '目标IP'},
                        'port': {'type': 'integer', 'description': '端口', 'default': 3389},
                    },
                    'required': ['target_ip'],
                },
            },
        ...
        # ── 蜜罐审计 ────────────────────────────────────────────────────────
        {
            ...
            'function': {
                ...
                'parameters': {
                    'type': 'object',
                    'properties': {
                        'service_name': {'type': 'string', 'description': '服务筛选，如ssh'},
                        'limit': {'type': 'integer', 'description': '记录数', 'default': 50},
                    },
                    'required': [],
                },
            },
        ...
        # ── 报告生成 ────────────────────────────────────────────────────────
        {
            ...
            'function': {
                ...
                'parameters': {
                    'type': 'object',
                    'properties': {
                        'exec_summary': {'type': 'string', 'description': '执行摘要'},
                    },
